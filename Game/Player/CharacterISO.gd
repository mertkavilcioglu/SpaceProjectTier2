...
func _process(delta): 
	...
	if (rotation > PI*15/16 and rotation <= PI/16): #sag 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir6.png")	
		#ship_body.rotation = rotation
	if (rotation > PI/16 and rotation <= PI*3/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir7.png")
		#ship_body.rotation = rotation - PI/8
	if (rotation > PI*3/16 and rotation <= PI*5/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir8.png")
		#ship_body.rotation = rotation - PI/2
	if (rotation > PI*5/16 and rotation <= PI*7/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir1.png")
		#ship_body.rotation = rotation - PI/2
	if (rotation > PI*7/16 and rotation <= PI*9/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir2.png")
		#ship_body.rotation = rotation - PI/2
	if (rotation > PI*9/16 and rotation <= PI*11/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir3.png")
		#ship_body.rotation = rotation - PI/2
	if (rotation > PI*11/16 and rotation <= PI*13/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir4.png")
		#ship_body.rotation = rotation - PI/2
	if (rotation > PI*13/16 and rotation <= PI*15/16): 
		ship_body.texture = load("res://Sprites/uzaygemisi/Diverger/512/Isometric/Diverger_Isometric_dir5.png")
		#ship_body.rotation = rotation - PI/2
